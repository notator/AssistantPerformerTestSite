...
namespace AP
{
	export class Message
	{
		...
		constructor(status: number, data1Arg: number, data2Arg: number)
		{
			...
			length = 3 // temp value ji -- june 2018
		...
		private _getDataValues(argsLength: number, data1Arg: number, data2Arg:number): {data1:number, data2:number}
		{
			var values = { data1: 0, data2: 0 };
		...
		private _checkArgSizes(status: number, data1:number, data2:number)
		{
